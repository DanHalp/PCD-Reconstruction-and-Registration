...
CFG.TRANSFORM.model_path = Path("/home/danha/PCD-Reconstruction-and-Registration/Checkpoints/ShapeNet/run_09_59_27_07_2022/model.best_epoch_1_7200.t7")
...
CFG.TRANSFORM.cycle = [True, False][0]
...
CFG.TRANSFORM.dataset_fraction = 1 
CFG.TRANSFORM.batch_size = 12
CFG.TRANSFORM.lr = 5e-3
CFG.TRANSFORM.epochs = 10
CFG.TRANSFORM.val_every = 200
CFG.TRANSFORM.optim_scheduler_step_size = 100
CFG.TRANSFORM.optim_scheduler_gamma = 0.8
CFG.TRANSFORM.early_stop_thresh = 3
